...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20241130134638_mig_add_notif_icon")]
    partial class mig_add_notif_icon
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EntityLayer.Entities.CafeTable", b =>
                {
                    b.Property<int>("CafeTableID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("CafeTableID"), 1L, 1);
            ...
            modelBuilder.Entity("EntityLayer.Entities.ContactMe", b =>
                {
            ...
            modelBuilder.Entity("EntityLayer.Entities.Notification", b =>
                {
                    ...
                    b.Property<string>("NotificationTypeText")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("EntityLayer.Entities.Basket", b =>
                {
                    b.HasOne("EntityLayer.Entities.CafeTable", "CafeTable")
                        .WithMany("Baskets")
